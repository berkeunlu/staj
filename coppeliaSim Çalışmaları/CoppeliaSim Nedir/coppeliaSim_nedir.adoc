...
image::C:\github_repos\staj\coppeliaSim Çalışmaları\CoppeliaSim Nedir\img\vrep-support-comparison.png[Tablo-2 V-Rep'de desteklenen beş programlama tekniğinin karşılaştırması]
